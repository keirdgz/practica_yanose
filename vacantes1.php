...
<center><h1>Vacantes</h1></center>

<form action="vacantes1.php"  method="post">

   <p>Nombre de la empresa:<br> 
   <input type ="text" class="formu" name="nombre_emp" size ="50"></p>
   <p>Nombre del puesto:<br>
   <input type="text" class="formu" name="nombre_puest" size="50"></p>
   <p>Funciones del puesto:<br>
   <textarea class="formu" name="funciones_puest"></textarea></p>
   <p>Sueldo: <br>
    <input type="text" class="formu" name="sueldo" size="50"></p>
   <p>Ubicacion:<br> 
    <input type="text" class="formu" name="ubicacion" size="50"></p>
   ...
   <p>Horario:<br> 
    <input type="text" class="formu" name="horario" size="50"></p>
   <p>Correo para los curriculums:<br> 
    <input type="text" class="formu" name="curriculum" size="50"></p>
   <p>Persona de contacto:<br> 
    <input type="text" class="formu" name="persona_contact" size="50"></p>
   <p>Telefono:<br>
    <input type="text" class="formu" name="telefono" size="50"></p>
    <br> 
    
    <input type="submit" class="botons" value="Borrar">
    <input type="submit" class="botons" value="Editar">
