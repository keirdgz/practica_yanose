...
<input type="text" class="formu" name="nom_emp" size="50"></p>

<p>RNC:<br>
<input type="text" class="formu" name="rnc" size="50"></p>

<p>¿Desea que se conozca la identidad de su empresa?<br>
<input type="radio" class="formu" name="ident_emp" value="Si">Si
<input type="radio" class="formu" name="ident_emp" value="No">No </p>
...
<input type="radio" class="formu" name="dept_formacion" value="No">No </p>

<p>Alcance de la empresa:<br>
<input type="radio" class="formu" name="alcance_emp" value="Nacional/Local">Nacional/Local
<input type="radio" class="formu" name="alcance_emp" value="Multinacional">Multinacional </p>

<p>Actividad económica a la que se dedica la empresa:<br>
<textarea class="formu" name="actividad_emp"></textarea></p>
...
<p>Dirección:<br>
<input type="text"class="formu" name="direccion" size="50"></p>

<p>Sector:<br>
<input type="text" class="formu" name="sector" size="50"></p>

<p>Sección:
<input type="text" class="formu" name="seccion" size="50"></p>

<p>Municipio:<br>
<input type="text" class="formu" name="municipio" size="50"></p>
...
<input type="text" class="formu" name="tel_principal" size="50"></p>

<p>Teléfono Directo:<br>
<input type="text" class="formu" name="tel_directo" size="50"></p>

<p>Email:<br>
<input type="email" class="formu" name="email" size="50"></p>

<p>Confirme su Email:<br>
<input type="text" class="formu" name="confirmacion_email" size="50"></p>

<p>Escribe una contraseña:<br>
<input type="password" class="formu" name="contrasena" size="50"></p>

<p>Confirme su Contraseña:<br>
<input type="password" class="formu" name="confirmacion_contrasena" size="50"></p>

<p>Contacto dentro de la empresa:<br>
<input type="text" class="formu" name="contacto_dentro_emp" size="50"></p>

<p>Teléfono y Extensión:<br>
<input type="text" class="formu" name="tel_contacto"></p>

<p>Correo:<br>
<input type="text" class="formu" name="email_contacto" id=correo required data-error="Por favor, ingrese su email."></p>
