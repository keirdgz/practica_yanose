...
<body>
    ...
    <main class="container o-container">
        ...
        <div class="container marketing">
          <center><h2 class="h2">Cantidad de horas correspondientes a pasantía por taller:</h2></center>
              <br>
              ...
              <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      <center><h5 class="card-title">360 horas</h5></center>
                ...
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                      <center><h5 class="card-title">720 horas</h5></center>
